...
| 항목                     | 상세내용                                                     |
| ------------------------ | ------------------------------------------------------------ |
| 어플리케이션 이름        | Spring Boot OAuth 2.0 Server                                 |
| 기능/역할                | 인증 서버                                                    |
...
| 사용 도구 및  라이브러리 | - org.springframework.boot                                <br/>- org.springframework.boot:spring-boot-starter-web        <br/>- org.springframework.boot:spring-boot-starter-security<br/>- org.springframework.security:spring-security-oauth2-authorization-server |
| 호스팅 플랫폼            | AWS EKS                                                      |
...
| org.springframework.security:spring-security-oauth2-authorization-server | 0.4.0   |
